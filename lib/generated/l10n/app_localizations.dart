...
abstract class AppLocalizations {
  ...
  /// No description provided for @designSystemVariant.
  ///
  /// In en, this message translates to:
  /// **'Design system variant'**
  String get designSystemVariant;
  ...
  /// No description provided for @variantOcean.
  ///
  /// In en, this message translates to:
  /// **'Ocean'**
  String get variantOcean;
  ...
  /// No description provided for @premiered.
  ///
  /// In en, this message translates to:
  /// **'Premiered'**
